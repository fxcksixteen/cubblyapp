      ...
      <div className="relative z-10 flex flex-col items-center pt-56 gap-6 px-4">
        ...
        <div className="flex flex-col sm:flex-row items-start justify-center gap-4">
          ...
          <a
            ...
            className="btn-fill relative flex items-center gap-2 rounded-full border border-foreground/30 bg-foreground/10 px-7 py-3.5 text-base font-semibold text-foreground backdrop-blur-sm transition-all overflow-hidden font-body self-start sm:mt-0 mt-0"
          >
