...
import { Phone, PhoneOff, Mic, MicOff, Volume2, VolumeX, Monitor, Video, VideoOff, Users } from "lucide-react";
    ...
    <div className="mx-4 mt-4 rounded-2xl overflow-hidden border" style={{ backgroundColor: "var(--app-bg-tertiary)", borderColor: "var(--app-border)" }}>
      ...
      <div className="flex items-center justify-between px-5 py-3 border-b" style={{ borderColor: "var(--app-border)" }}>
        ...
        <div className="flex items-center gap-1.5">
          <Users className="h-3.5 w-3.5" style={{ color: "var(--app-text-secondary)" }} />
          <span className="text-xs" style={{ color: "var(--app-text-secondary)" }}>2</span>
        </div>
      </div>
        ...
        <div className="flex flex-col items-center gap-2">
          <div className="relative">
            <div
              ...
              style={{ backgroundColor: recipientColor.bg }}
            >
              {recipientName.charAt(0).toUpperCase()}
            </div>
          </div>
          <span className="text-sm font-semibold" style={{ color: "var(--app-text-primary)" }}>{recipientName}</span>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center gap-3 px-6 pb-5">
        <button
          ...
          className={`flex h-10 w-10 items-center justify-center rounded-full transition-all duration-150 ${
            activeCall.isMuted
              ? "bg-white/15 ring-2 ring-[#ed4245]/50"
  ...
  return (
    <div className="my-3 flex justify-center">
      ...
      >
        ...
        {state === "ongoing" && (
          <>
            <div className="w-px h-5" style={{ backgroundColor: "var(--app-border)" }} />
            <button
              onClick={onJoin}
...
const VoiceCallOverlay = () => {
  ...
  // Only show the incoming call banner (the in-chat panel handles active calls now)
