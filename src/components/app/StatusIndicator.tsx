...
const sizeMap = {
  sm: { container: "h-[15px] w-[15px]", icon: "h-[11px] w-[11px]", border: "border-[2.5px]" },
  md: { container: "h-[18px] w-[18px]", icon: "h-[13px] w-[13px]", border: "border-[3px]" },
  lg: { container: "h-[22px] w-[22px]", icon: "h-[16px] w-[16px]", border: "border-[3px]" },
};
